...
class OpaqueInvokeHelperSquare<T extends Opaque> extends InvokeHelper<Pointer<Pointer<T>>> {
  OpaqueInvokeHelperSquare(Function? base, Memory? memory) : super(base, memory);
