...
SPINE_C_API spine_attachment spine_slot_pose_get_attachment(spine_slot_pose self);
SPINE_C_API void spine_slot_pose_set_attachment(spine_slot_pose self, spine_attachment attachment);
