...
SPINE_C_API spine_bone spine_skeleton_get_root_bone(spine_skeleton self);
SPINE_C_API spine_bone spine_skeleton_find_bone(spine_skeleton self, const char* boneName);
SPINE_C_API spine_array_slot spine_skeleton_get_slots(spine_skeleton self);
SPINE_C_API spine_slot spine_skeleton_find_slot(spine_skeleton self, const char* slotName);
SPINE_C_API spine_array_slot spine_skeleton_get_draw_order(spine_skeleton self);
SPINE_C_API spine_skin spine_skeleton_get_skin(spine_skeleton self);
SPINE_C_API void spine_skeleton_set_skin_1(spine_skeleton self, const char* skinName);
SPINE_C_API void spine_skeleton_set_skin_2(spine_skeleton self, spine_skin newSkin);
SPINE_C_API spine_attachment spine_skeleton_get_attachment_1(spine_skeleton self, const char* slotName, const char* attachmentName);
SPINE_C_API spine_attachment spine_skeleton_get_attachment_2(spine_skeleton self, int slotIndex, const char* attachmentName);
...
SPINE_C_API void spine_skeleton_get_bounds_1(spine_skeleton self, float* outX, float* outY, float* outWidth, float* outHeight, spine_array_float outVertexBuffer);
SPINE_C_API void spine_skeleton_get_bounds_2(spine_skeleton self, float* outX, float* outY, float* outWidth, float* outHeight, spine_array_float outVertexBuffer, spine_skeleton_clipping clipper);
